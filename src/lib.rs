...
//! - the function [ctypes::lam_helper] and [ctypes::pi_helper] (and their polymorphic variants) handle de bruijn indexing for you.
...
//! - don't write the proofs directly in this language -- translate them!  This is not a proof assistant, and using it as one will be painful.
//! 
//! Refer to the the source code of [numbers], [mod@bool], [equals], and [impossible] to see how proofs are constructed in more detail
